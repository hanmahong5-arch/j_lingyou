DROP TABLE IF EXISTS xmldb_suiyue.client_login_event;
CREATE TABLE xmldb_suiyue.client_login_event (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'client_login_event';

DROP TABLE IF EXISTS xmldb_suiyue.client_login_event__reward_item_list__data;
CREATE TABLE xmldb_suiyue.client_login_event__reward_item_list__data (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'client_login_event__reward_item_list__data';
