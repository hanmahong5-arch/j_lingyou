DROP TABLE IF EXISTS xmldb_suiyue.client_skill_charge;
CREATE TABLE xmldb_suiyue.client_skill_charge (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'client_skill_charge';
