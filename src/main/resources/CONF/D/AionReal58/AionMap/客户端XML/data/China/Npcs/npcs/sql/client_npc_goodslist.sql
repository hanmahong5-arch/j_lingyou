DROP TABLE IF EXISTS xmldb_suiyue.client_npc_goodslist;
CREATE TABLE xmldb_suiyue.client_npc_goodslist (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'client_npc_goodslist';

DROP TABLE IF EXISTS xmldb_suiyue.client_npc_goodslist__goods_list__data;
CREATE TABLE xmldb_suiyue.client_npc_goodslist__goods_list__data (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'client_npc_goodslist__goods_list__data';

DROP TABLE IF EXISTS xmldb_suiyue.client_npc_goodslist__data__data;
CREATE TABLE xmldb_suiyue.client_npc_goodslist__data__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `item` VARCHAR(69) COMMENT 'item'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'client_npc_goodslist__data__data';
