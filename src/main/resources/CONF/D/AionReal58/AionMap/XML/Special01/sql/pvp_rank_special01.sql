DROP TABLE IF EXISTS xmldb_suiyue.pvp_rank_special01;
CREATE TABLE xmldb_suiyue.pvp_rank_special01 (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'pvp_rank_special01';
