...
CREATE TABLE xmldb_suiyue.quest (
    ...
    `drop_monster_5` TEXT COMMENT 'drop_monster_5',
    `drop_item_5` TEXT COMMENT 'drop_item_5',
    `drop_prob_5` TEXT COMMENT 'drop_prob_5',
    `drop_each_member_5` TEXT COMMENT 'drop_each_member_5',
    `drop_monster_6` TEXT COMMENT 'drop_monster_6',
    `drop_item_6` TEXT COMMENT 'drop_item_6',
    `drop_prob_6` TEXT COMMENT 'drop_prob_6',
    `drop_each_member_6` TEXT COMMENT 'drop_each_member_6',
    `drop_monster_7` TEXT COMMENT 'drop_monster_7',
    `drop_item_7` TEXT COMMENT 'drop_item_7',
    `drop_prob_7` TEXT COMMENT 'drop_prob_7',
    `drop_each_member_7` TEXT COMMENT 'drop_each_member_7',
    `drop_monster_8` TEXT COMMENT 'drop_monster_8',
    `drop_item_8` TEXT COMMENT 'drop_item_8',
    `drop_prob_8` TEXT COMMENT 'drop_prob_8',
    `drop_each_member_8` TEXT COMMENT 'drop_each_member_8',
    `drop_monster_9` TEXT COMMENT 'drop_monster_9',
    `drop_item_9` TEXT COMMENT 'drop_item_9',
    `drop_prob_9` TEXT COMMENT 'drop_prob_9',
    `drop_each_member_9` TEXT COMMENT 'drop_each_member_9',
