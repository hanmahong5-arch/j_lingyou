DROP TABLE IF EXISTS xmldb_suiyue.instance_cooltime_special01;
CREATE TABLE xmldb_suiyue.instance_cooltime_special01 (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'instance_cooltime_special01';

DROP TABLE IF EXISTS xmldb_suiyue.instance_cooltime_special01__data__data;
CREATE TABLE xmldb_suiyue.instance_cooltime_special01__data__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `variable` VARCHAR(43) COMMENT 'variable'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'instance_cooltime_special01__data__data';

DROP TABLE IF EXISTS xmldb_suiyue.instance_cooltime_special01__ext_condition_variable__data;
CREATE TABLE xmldb_suiyue.instance_cooltime_special01__ext_condition_variable__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `variable` VARCHAR(43) COMMENT 'variable'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'instance_cooltime_special01__ext_condition_variable__data';
