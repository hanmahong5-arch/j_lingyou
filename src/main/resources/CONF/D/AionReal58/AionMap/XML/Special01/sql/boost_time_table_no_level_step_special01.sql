DROP TABLE IF EXISTS xmldb_suiyue.boost_time_table_no_level_step_special01;
CREATE TABLE xmldb_suiyue.boost_time_table_no_level_step_special01 (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'boost_time_table_no_level_step_special01';
