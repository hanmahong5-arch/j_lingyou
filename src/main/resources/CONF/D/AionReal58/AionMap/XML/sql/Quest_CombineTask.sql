DROP TABLE IF EXISTS xmldb_suiyue.Quest_CombineTask;
CREATE TABLE xmldb_suiyue.Quest_CombineTask (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'Quest_CombineTask';
