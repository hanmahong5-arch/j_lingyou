DROP TABLE IF EXISTS xmldb_suiyue.boost_time_table_no_level_step_inter;
CREATE TABLE xmldb_suiyue.boost_time_table_no_level_step_inter (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'boost_time_table_no_level_step_inter';
