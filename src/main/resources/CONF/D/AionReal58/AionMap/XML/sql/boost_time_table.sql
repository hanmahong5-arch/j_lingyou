DROP TABLE IF EXISTS xmldb_suiyue.boost_time_table;
CREATE TABLE xmldb_suiyue.boost_time_table (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'boost_time_table';
