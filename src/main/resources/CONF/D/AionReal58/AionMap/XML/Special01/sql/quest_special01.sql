DROP TABLE IF EXISTS xmldb_suiyue.quest_special01;
CREATE TABLE xmldb_suiyue.quest_special01 (
    ...
    `reward_item6_1` TEXT COMMENT 'reward_item6_1',
    ...
    `reward_item2_3` TEXT COMMENT 'reward_item2_3',
    `reward_gold3` TEXT COMMENT 'reward_gold3',
    `reward_item3_2` TEXT COMMENT 'reward_item3_2',
    `reward_item3_3` TEXT COMMENT 'reward_item3_3',
    `reward_gold4` TEXT COMMENT 'reward_gold4',
    `reward_item4_2` TEXT COMMENT 'reward_item4_2',
    ...
    `reward_item2_4` TEXT COMMENT 'reward_item2_4',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'quest_special01';

DROP TABLE IF EXISTS xmldb_suiyue.quest_special01__fighter_selectable_reward__data;
CREATE TABLE xmldb_suiyue.quest_special01__fighter_selectable_reward__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `fighter_selectable_item` VARCHAR(36) COMMENT 'fighter_selectable_item'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'quest_special01__fighter_selectable_reward__data';

DROP TABLE IF EXISTS xmldb_suiyue.quest_special01__knight_selectable_reward__data;
CREATE TABLE xmldb_suiyue.quest_special01__knight_selectable_reward__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `knight_selectable_item` VARCHAR(36) COMMENT 'knight_selectable_item'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'quest_special01__knight_selectable_reward__data';

DROP TABLE IF EXISTS xmldb_suiyue.quest_special01__ranger_selectable_reward__data;
CREATE TABLE xmldb_suiyue.quest_special01__ranger_selectable_reward__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `ranger_selectable_item` VARCHAR(37) COMMENT 'ranger_selectable_item'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'quest_special01__ranger_selectable_reward__data';

DROP TABLE IF EXISTS xmldb_suiyue.quest_special01__assassin_selectable_reward__data;
CREATE TABLE xmldb_suiyue.quest_special01__assassin_selectable_reward__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `assassin_selectable_item` VARCHAR(36) COMMENT 'assassin_selectable_item'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'quest_special01__assassin_selectable_reward__data';

DROP TABLE IF EXISTS xmldb_suiyue.quest_special01__wizard_selectable_reward__data;
CREATE TABLE xmldb_suiyue.quest_special01__wizard_selectable_reward__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `wizard_selectable_item` VARCHAR(36) COMMENT 'wizard_selectable_item'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'quest_special01__wizard_selectable_reward__data';

DROP TABLE IF EXISTS xmldb_suiyue.quest_special01__elementalist_selectable_reward__data;
CREATE TABLE xmldb_suiyue.quest_special01__elementalist_selectable_reward__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `elementalist_selectable_item` VARCHAR(41) COMMENT 'elementalist_selectable_item'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'quest_special01__elementalist_selectable_reward__data';

DROP TABLE IF EXISTS xmldb_suiyue.quest_special01__priest_selectable_reward__data;
CREATE TABLE xmldb_suiyue.quest_special01__priest_selectable_reward__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `priest_selectable_item` VARCHAR(37) COMMENT 'priest_selectable_item'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'quest_special01__priest_selectable_reward__data';

DROP TABLE IF EXISTS xmldb_suiyue.quest_special01__chanter_selectable_reward__data;
CREATE TABLE xmldb_suiyue.quest_special01__chanter_selectable_reward__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `chanter_selectable_item` VARCHAR(40) COMMENT 'chanter_selectable_item'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'quest_special01__chanter_selectable_reward__data';

DROP TABLE IF EXISTS xmldb_suiyue.quest_special01__gunner_selectable_reward__data;
CREATE TABLE xmldb_suiyue.quest_special01__gunner_selectable_reward__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `gunner_selectable_item` VARCHAR(36) COMMENT 'gunner_selectable_item'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'quest_special01__gunner_selectable_reward__data';

DROP TABLE IF EXISTS xmldb_suiyue.quest_special01__bard_selectable_reward__data;
CREATE TABLE xmldb_suiyue.quest_special01__bard_selectable_reward__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `bard_selectable_item` VARCHAR(37) COMMENT 'bard_selectable_item'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'quest_special01__bard_selectable_reward__data';

DROP TABLE IF EXISTS xmldb_suiyue.quest_special01__rider_selectable_reward__data;
CREATE TABLE xmldb_suiyue.quest_special01__rider_selectable_reward__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `rider_selectable_item` VARCHAR(36) COMMENT 'rider_selectable_item'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'quest_special01__rider_selectable_reward__data';
