DROP TABLE IF EXISTS xmldb_suiyue.airline;
CREATE TABLE xmldb_suiyue.airline (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'airline';

DROP TABLE IF EXISTS xmldb_suiyue.airline__airline_list__data;
CREATE TABLE xmldb_suiyue.airline__airline_list__data (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'airline__airline_list__data';
