DROP TABLE IF EXISTS xmldb_suiyue.polymorph_temp_skill;
CREATE TABLE xmldb_suiyue.polymorph_temp_skill (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'polymorph_temp_skill';
