DROP TABLE IF EXISTS xmldb_suiyue.pvp_mod_table;
CREATE TABLE xmldb_suiyue.pvp_mod_table (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'pvp_mod_table';
