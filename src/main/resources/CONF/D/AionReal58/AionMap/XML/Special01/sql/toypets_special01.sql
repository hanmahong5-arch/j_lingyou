DROP TABLE IF EXISTS xmldb_suiyue.toypets_special01;
CREATE TABLE xmldb_suiyue.toypets_special01 (
    ...
    `target_sound` VARCHAR(20) COMMENT 'target_sound',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'toypets_special01';

DROP TABLE IF EXISTS xmldb_suiyue.toypets_special01__ui_colors__data;
CREATE TABLE xmldb_suiyue.toypets_special01__ui_colors__data (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `ui_color` VARCHAR(9) COMMENT 'ui_color'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'toypets_special01__ui_colors__data';

DROP TABLE IF EXISTS xmldb_suiyue.toypets_special01__bound_radius;
CREATE TABLE xmldb_suiyue.toypets_special01__bound_radius (
    `id` VARCHAR(255) COMMENT '继承父id',
    `__order_index` INT NOT NULL DEFAULT 0 COMMENT '顺序索引',
    `front` VARCHAR(8) COMMENT 'front',
    `side` VARCHAR(8) COMMENT 'side',
    `upper` VARCHAR(8) COMMENT 'upper'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'toypets_special01__bound_radius';
