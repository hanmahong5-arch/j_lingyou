...
DROP TABLE IF EXISTS xmldb_suiyue.quest__progress_info__data;
CREATE TABLE xmldb_suiyue.quest__progress_info__data (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT = 'quest__progress_info__data';
